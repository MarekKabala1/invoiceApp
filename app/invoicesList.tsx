...
export default function AllInvoicesPage() {
  ...
  const renderInvoiceItem = ({ item }: { item: InvoiceType }) => (
    <TouchableOpacity
  ...
  return (
    <View className="flex-1 bg-gray-100 p-4">
      <FlatList
        ...
        data = {[{id: '1', customer_id: 'John Doe', invoice_date: new Date(), due_date: new Date(), amount_before_tax: 100, amount_after_tax: 120}]}
