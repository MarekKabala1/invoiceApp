...
<body>
    <div class="container">
        <div class="header">
            ...
            <div>
                <h1 class="estimate-title">Estimate #${data.id}</h1>
                <p class="date">Valid Until: ${customFormat(new Date(data.estimateEndTime))}</p>
            </div>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th>Description</th>
                    <th class="align">Amount</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="txt-med">Estimated Services</td>
                    <td class="align txt-med">${getCurrencySymbol(data.currency)}${data.amountBeforeTax.toFixed(2)}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                ...
                <tr>
                    ...
                    <td class="align txt-med">-${getCurrencySymbol(data.currency)}${((subtotal * data.discount) / 100).toFixed(2)}</td>
                </tr>
                `
										: ''
								}
        ...
        <div class="notes-container">
            ...
            <p class="notes-txt">${data.notesText}</p>
        </div>
        `
						: ''
				}
